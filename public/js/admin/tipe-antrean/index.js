$(document).ready(function () {
    const token = $("#tipeAntreanForm").data("token");
    const indexUrl = $("#tipeAntreanForm").data("index-url");
    const editUrl = $("#tipeAntreanForm").data("edit-url");
    const destroyUrl = $("#tipeAntreanForm").data("destroy-url");
    const successMessage = $("#tipeAntreanForm").data("success-message");
    const errorMessage = $("#tipeAntreanForm").data("error-message");
    ...
    function format(d) {
        ...
        <table>
            <tr>
                <td>Edit Data Tipe Antrean:</td>
                <td>
                    <a href="${editUrl}" class="btn btn-info">
                        <i class="fa fa-edit"></i> &nbsp; Edit Data Tipe Antrean
                    </a>
                </td>
            </tr>
            <tr>
                <td>Hapus Data Tipe Antrean:</td>
                <td>
                    <form action="${deleteUrl}" method="POST" class="deleteForm">
                        ...
                        <button type="submit" class="btn btn-danger" onclick="return confirm('Apakah anda yakin untuk menghapus data ini ?')">
                            <i class="fa fa-times"></i> &nbsp; Hapus Data Tipe Antrean
                        </button>
                    </form>
                </td>
            </tr>
