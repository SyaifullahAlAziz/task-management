$(document).ready(function () {
    const token = $("#kategoriForm").data("token");
    const indexUrl = $("#kategoriForm").data("index-index");
    const editUrl = $("#kategoriForm").data("edit-url");
    const destroyUrl = $("#kategoriForm").data("destroy-url");
    const successMessage = $("#kategoriForm").data("success-message");
    const errorMessage = $("#kategoriForm").data("error-message");
    $.ajaxSetup({
        headers: {
    ...
    function format(d) {
        ...
        <table>
            <tr>
                <td>Edit Kategori Keperawatan:</td>
                <td>
                    <a href="${editUrl}" class="btn btn-info">
                        <i class="fa fa-edit"></i> &nbsp; Edit Kategori Keperawatan
                    </a>
                </td>
            </tr>
            <tr>
                <td>Hapus Kategori Keperawatan:</td>
                <td>
                    <form action="${deleteUrl}" method="POST" class="deleteForm">
                        ...
                        <button type="submit" class="btn btn-danger" onclick="return confirm('Apakah anda yakin untuk menghapus data ini ?')">
                            <i class="fa fa-times"></i> &nbsp; Hapus Kategori Keperawatan
                        </button>
                    </form>
                </td>
            </tr>
