$(document).ready(function () {
    const token = $("#loketForm").data("token");
    const indexUrl = $("#loketForm").data("index-url");
    const editUrl = $("#loketForm").data("edit-url");
    const destroyUrl = $("#loketForm").data("destroy-url");
    const successMessage = $("#loketForm").data("success-message");
    const errorMessage = $("#loketForm").data("error-message");
    ...
    function format(d) {
        ...
        <table>
            <tr>
                <td>Edit Data Loket:</td>
                <td>
                    <a href="${editUrl}" class="btn btn-info">
                        <i class="fa fa-edit"></i> &nbsp; Edit Data Loket
                    </a>
                </td>
            </tr>
            <tr>
                <td>Hapus Data Loket:</td>
                <td>
                    <form action="${deleteUrl}" method="POST" class="deleteForm">
                        ...
                        <button type="submit" class="btn btn-danger" onclick="return confirm('Apakah anda yakin untuk menghapus data ini ?')">
                            <i class="fa fa-times"></i> &nbsp; Hapus Data Loket
                        </button>
                    </form>
                </td>
            </tr>
