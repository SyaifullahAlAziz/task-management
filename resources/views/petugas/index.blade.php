...
<script>
    $(function () {
        ...
        let table = $('#tabel-petugas').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
        ...
        $('#tabel-petugas tbody').on('click', 'td.dt-control', function () {
        ...
        function format(d) {
            return `
            <div class="container">
                <a href="${d.edit_url}" class="btn btn-primary btn-sm"> <i class="fa fa-edit"> Ubah Data Petugas</i> </a>
                <a onclick="return confirm('Yakin Ingin Hapus Data?')" href="${d.delete_url}" class="btn btn-danger btn-sm"> <i class="fa fa-trash"> Hapus Data Petugas</i> </a>
            </div>
            `;
        }
...
<div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('petugas.insert') }}" method="post">
        ...
        <div class="modal-content">
            <form action="{{ route('petugas.update', $item->id) }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="">Nama Petugas</label>
                        <input type="text" name="nm_petugas" class="form-control" value="{{ $item->nm_petugas }}"
                            required>
                    </div>
                    <div class="form-group">
                        <label for="">Keterangan</label>
