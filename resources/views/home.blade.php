...
@section('content')
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-6">
                <div class="mb-3">
                    <h3 class="dashboard-title">Home</h3>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-lg-8 my-5">
                                <div class="mb-3 py-5">
                                    <h1 class="welcome-text">Selamat Datang di <span class="text-primary">Sistem Task Management</span>
                                    </h1>
                                    <h4 class="user-greeting">Halo, <span>{{ session('user.name') ?? 'Pengguna' }}</span>
                                    </h4>
                                </div>
                            </div>
                        </div>
