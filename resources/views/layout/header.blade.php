        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="navbar-brand-wrapper d-flex justify-content-center">
                <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
                    <a class="navbar-brand brand-logo" href="#"><img src="{{ asset('images/logo.jpg') }}"
                            alt="logo" /></a>
                ...
                <ul class="navbar-nav mr-lg-2">
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link" href="#" data-toggle="dropdown" id="profileDropdown">
                            <img src="{{ asset('admin/images/auth/' . session('user.foto_profile')) }}"
                                alt="profile" />
                            <span class="nav-profile-name">{{ session('user.name') }}</span>
                        </a>
                    ...
                    <li class="nav-item nav-user-status dropdown">
                        <p class="mb-0">  <i class="fa fa-circle" style="color: #08CB00;"> Online</i></p>
                    </li>
                </ul>
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item nav-date dropdown">
                        <a class="nav-link d-flex justify-content-center align-items-center" href="javascript:;">
                            <h6 class="date mb-0">Today : {{ \Carbon\Carbon::now()->translatedFormat('d F Y') }}</h6>
